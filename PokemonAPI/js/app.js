            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="row my-3 justify-content-center">
                        <div class="col-5">
                            <h6 class=" card-subtitle mt-2 text-center text-uppercase text-dark">${stats[0].stat.name}: <span class="text-danger">${stats[0].base_stat}</span></h6>
                        </div>
                        <div class="col-5">
                            <h6 class=" card-subtitle mt-2 text-center text-uppercase text-dark">ATK: <span class="text-danger">${stats[2].base_stat}</span></h6>
                        </div>
                        <div class="col-5">
                            <h6 class=" card-subtitle mt-2  text-center text-uppercase text-dark">SATK: <span class="text-danger">${stats[3].base_stat}</span></h6>
                        </div>
                        <div class="col-5">
                            <h6 class=" card-subtitle mt-2 text-center text-uppercase text-dark">XP:  <span class="text-primary">${base_experience}</span></h6>
                        </div>
                        <div class="col-5">
                            <h6 class=" card-subtitle mt-2 text-center text-uppercase text-dark">DFS: <span class="text-primary">${stats[2].base_stat}</span></h6>
                        </div>
                        <div class="col-5">
                            <h6 class=" card-subtitle mt-2 text-center text-uppercase  text-dark">SDFS: <span class="text-primary">${stats[4].base_stat}</span></h6>
                        </div>
                        <div class="col-5">
                            <h6 class=" card-subtitle mt-2 text-center text-uppercase text-dark">SPD: ${stats[5].base_stat}</h6>
                        </div>
                    </div>
                </div>
            </div>
